...
document.write("El resultado de la suma es "+resultado+" y es "+typeof(resultado)+"<br/>");
resultado = (op1-op2);
document.write("El resultado de la resta es "+resultado+" y es "+typeof(resultado)+"<br/>");
resultado = eval((op1+op2));
document.write("El resultado de la suma con eval es "+resultado+" y es "+typeof(resultado)+"<br/>");
